...
# /resume Protocol v2.3 (Git Drift Validation)

1. Read `.agent/memory/active_context.md`.
...
3. **IF VALIDATED**:
   - Load task contract and unchecked `[ ]` items from `.agent/specs/SPEC-<id>_<name>.md`.
